...
class PSCondition_Movie_Popup : PSAttributePopup, NSTextFieldDelegate, NSMenuDelegate {
    
    var scriptData : PSScriptData
    init(currentValue: String, scriptData : PSScriptData, setCurrentValueBlock : ((String) -> ())?){
        self.scriptData = scriptData
        super.init(nibName: "MovieCondition",bundle: NSBundle(forClass:self.dynamicType), currentValue: currentValue, displayName: "Mouse", setCurrentValueBlock: setCurrentValueBlock)
    }
    ...
    func parse() {
        ...
        for v in inputValue {
            ...
            if lcv == "done" {
                ...
                for time in lcv.componentsSeparatedByString(",") {
