...
class PSPortScript : NSObject {
    ...
    init(scriptData : PSScriptData) {
        ...
        if let portNames = scriptData.getBaseEntry("PortNames") {
            ...
            let newPortNamesEntry = PSStringList(entry: scriptData.getOrCreateBaseEntry("PortNames", type: "PortNames", user_friendly_name: "Port Names", section_name: "PortDefinitions",zOrder: 14), scriptData: scriptData)
            let entireScreen = scriptData.getOrCreateBaseEntry("Entire Screen", type: "Port", user_friendly_name: "Entire Screen", section_name: "PortDefinitions",zOrder: 14)
